...
const projectNames = [
    {
        ...
        source: "/src/assets/mastermind.png"
    },
    {
        id: 1,
        title: "Fridge-Mate",
        description: "FullStack Food Expiration Mobile App",
        source: "/src/assets/fridgemateImg.png"
    },
    {
        id: 2,
            ...
            <div className="grid sm: grid-cols-1 md:grid-cols-2 gap-4 pt-10">
                {
                    projectNames.map((project, index) => {
                        return <Project key={index} title={project["title"]} description={project["description"]} source={project["source"]}/>
                    }
                )}
            </div>
        </div>
